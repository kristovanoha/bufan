...
- Yahoo Finance pouziva jako hlavni zdroj a chybejici ucetni data americkych firem doplnuje z oficialniho SEC EDGAR API
...
- SEC EDGAR API: doplneni chybejicich oficialnich ucetnich vykazu americkych firem pro revenue, net income, cash, debt, equity, operating cash flow a dalsi odvozene pomery
- SEC Form 3/4/5: insider transakce vedeni, reditelu a 10% vlastniku

## Poznamky

- Pokud Yahoo Finance ani SEC nektere pole neposkytnou, aplikace zobrazi `N/A`.
- Pokud SEC EDGAR vrati omezeni typu `403` nebo `429`, aplikace prednostne pouzije data z Yahoo Finance a SEC pouzije jen tam, kde Yahoo hodnotu nema.
